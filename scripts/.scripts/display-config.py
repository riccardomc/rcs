...
class MyRandr(object):
    ...
    def get_resources(self):
        ...
        self.crtcs = {crtc_id: self.display.xrandr_get_crtc_info(crtc_id, 0) for crtc_id in self.resources.crtcs}

        self.modes = self._build_modes_dict(self.resources.mode_names, self.resources.modes)
        self.outputs = {o: self.display.xrandr_get_output_info(o, 0) for o in self.resources.outputs}
        self.connected_outputs = {i: o for i, o in self.outputs.items() if o._data['connection'] == 0}
    ...
    def _build_modes_dict(self, mode_names, modes):
        ...
        for mode in modes:
            ...
            mode_data['name'] = mode_names[last_index:last_index + mode_data['name_length']]
    ...
    def set_from_left_to_right(self, leftmost_output_name):
        ...
        for output_id in self.connected_outputs.keys():
